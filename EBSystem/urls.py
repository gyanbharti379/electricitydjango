...
from user.views import forgetpassword,employeeDashboard,customerRegistrationForm,billingPage,reminderForm,customerRegistration,meterRegistration,serviceChargeRegistration, calculateBillForm, calFindCustomer, updateProfile, generateBillForm, findCustomer,showAllCustomer,billingPage_Form, payBillForm,reminderFindCustomerPage_Form,sendWBmessage, sendReminderEmail
from customer.views import customerDashboard,customerLogin, cusSignUp, newCustomer, showCustomerDetails
...
# --------------website static page ----------------------------#
    ...
    path('new_user/',newCustomer, name="signup"),
    path('forgetpass/',forgetpassword, name="forgetpass"),
   
# #----------------------Dynamic page ----------------------------------# 
# # ---------- App View -------------------  

    path('submitloginForm/', customerLogin, name="submitloginForm"),
